      ...
      <div className="container grid md:grid-cols-2 gap-10 items-start">
        ...
        >
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="card p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
            ...
            <div className="card p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
              ...
              <div className="text-gray-600 dark:text-gray-300 text-sm">Insurer Partners</div>
            </div>
            <div className="card p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
              <div className="text-2xl font-bold text-brand-700">5k+</div>
              <div className="text-gray-600 dark:text-gray-300 text-sm">Claims Assisted</div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="card p-6 space-y-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl"
        >
